...
function NavBar(props) {
    ...
    const dark = <FontAwesomeIcon icon={faMoon} onClick={darkMode} className={`py-2 px-3 mx-1 cursor-pointer ${activeDark} rounded-xl`} />
    const light = <FontAwesomeIcon icon={faSun} onClick={lightMode} className={`py-2 px-3 mx-1 cursor-pointer ${activeLight} rounded-xl`} />
    const [menuBtn, setmenuBtn] = useState(bars)
    return (
        <div className='py-4 bg-inherit sticky top-0 z-30'>
            {/* For Mobile */}
            ...
            <div className="lg:flex hidden justify-between px-4 lg:px-5">
                ...
                <ul className='flex space-x-5 self-center text-md font-semibold'>
                    ...
                    <a href='#works' className='hover:text-purple-700 duration-300'><li>Works</li></a>
                </ul>
