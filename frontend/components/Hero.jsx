...
export default function Hero() {
  ...
  return (
    <div className="md:flex justify-between my-10">
      <div data-aos="fade-right" data-aos-duration="1500" className="flex flex-col justify-center space-y-5 py-10">
        ...
        <button className='font-semibold duration-300 w-fit hover:bg-gradient hover:bg-[#121212] hover:scale-105 py-4 px-8 bg-purple-700 text-sm rounded-lg text-white'>Download CV</button>

      </div>
      <img data-aos="fade-left" data-aos-duration="1500"
        src="/profile.svg" className="md:block hidden h-auto w-full object-cover rounded-xl" alt="Profile Pic" />
