...
function Services() {
    const [devClass, setDevClass] = useState("bg-purple-500 text-white")
    ...
    const handleService = (e => {
        ...
        if (service == "Web Development") {
            setDevClass("bg-purple-500 text-white")
            setMainClass("")
            setAppClass("")
        }
        else if (service == "Web Applications") {
            setDevClass("")
            setAppClass("bg-purple-500 text-white")
            setMainClass("")
        }
        else {
            setDevClass("")
            setAppClass("")
            setMainClass("bg-purple-500 text-white")
        }
    ...
    return (
        <div id="services">
            ...
            <div className='my-10'>
                <ul className='hidden lg:flex text-xl rounded-xl px-10 gap-4 font-semibold py-4 bg-gray-300'>
                ...
                <div className='py-5 mx-2 lg:mx-10 text-lg font-semibold '>
